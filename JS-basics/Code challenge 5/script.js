...
1. Create an object with an arrray for the bill values.
...
Mark's family also went on a holiday, going to 4 different restaurants. The
bills were $77, $375, $110 and $45.
Mark likes to tip 20% of the bill when bill is less than $100, 
10% when the bill is between $100 and $300 and 25% when the bill is 
more than $300.

5. Implement the same functionality as before, this time using Mark's rules.
6. Create a function (not a method) to calculate the average of a given 
array of tips. 
HINT: Loop over the array, nad in each iteration store the current 
...
var john = {
	...
	calcTips: function() {
		...
		{
			// determine percentage based on tipping rule
